...
const roofing = [
    {
        ...
        features: ["Rust-resistant finish", "Minimalist design", "Easy installation", "Durable against harsh weather"],
    },
    {
        src: Roof2,
        ...
        features: ["High-strength steel", "Weatherproof coating", "Open-air design for ventilation", "Customizable size options"],
    },
    {
        src: Roof3,
        ...
        features: ["Slanted design", "Custom color options", "Durable support poles", "Aesthetic appeal"],
    },
    {
        src: Roof4,
        ...
        features: ["UV-resistant material", "Sleek silver finish", "Low maintenance", "Robust frame construction"],
    },
    {
        src: Roof5,
        ...
        features: ["Integrated gutter system", "Available in multiple colors", "Excellent corrosion resistance", "Provides sun and rain protection"],
    },
    {
        src: Roof6,
        ...
        features: ["Durable and strong", "Weather-resistant", "Custom length options", "Provides a shaded path"],
    },
    {
        src: Roof7,
        ...
        features: ["Clean white finish", "Lightweight and strong", "Minimalist support structure", "Weatherproof coating"],
    },
    {
        src: Roof8,
        ...
        features: ["Pitched roof for water drainage", "Rust-resistant poles", "Ideal for outdoor living areas", "Sturdy construction"],
    },
    {
        src: Roof9,
        ...
        features: ["Integrated concrete base", "Modern, angular design", "Exceptional durability", "Versatile use for any outdoor area"],
    },
    {
        src: Roof10,
        ...
        features: ["High-span design", "Robust truss system", "Maximum vertical space", "Suitable for industrial or large-scale projects"],
    },
];

const Roofing = () => (
    <GalleryCollection
        title="Premium Roofing Collection"
        intro="We craft durable, weather-ready metal roofing solutions for homes, shops, parking areas, workshops, and custom outdoor spaces."
        bullets={[
            "Explore proven designs or bring your own site requirement",
            "Pricing is based on size, material, structure, and complexity",
